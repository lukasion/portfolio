var U=Object.defineProperty;var q=(c,e,s)=>e in c?U(c,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):c[e]=s;var a=(c,e,s)=>(q(c,typeof e!="symbol"?e+"":e,s),s);import{_ as G}from"./C71kw17w.js";import{f as x,r as f,z as N,A as W,c as v,B as X,C as S,o as p,a as t,h as r,D as b,t as y,j as R,p as H,e as Y,b as h,d as g,E as Q,g as F,v as A,F as D,x as O,q as B,w as J}from"./BMqdsSox.js";import{u as z,_ as K}from"./DVsQ8V5o.js";import{_ as j}from"./DlAUqK2U.js";import M from"./BeBAN0US.js";import"./BLmlk9bP.js";import"./Bcw-ZHf8.js";const Z=Symbol.for("nuxt:client-only"),ee=x({name:"ClientOnly",inheritAttrs:!1,props:["fallback","placeholder","placeholderTag","fallbackTag"],setup(c,{slots:e,attrs:s}){const n=f(!1);return N(()=>{n.value=!0}),W(Z,!0),i=>{var m;if(n.value)return(m=e.default)==null?void 0:m.call(e);const l=e.fallback||e.placeholder;if(l)return l();const o=i.fallback||i.placeholder||"",u=i.fallbackTag||i.placeholderTag||"span";return v(u,s,o)}}}),te=""+new URL("mobile.9S7sboHz.jpg",import.meta.url).href,se=""+new URL("doger-desktop.n8T5WlF3.jpg",import.meta.url).href,E=X("skillsChart",()=>{const c=f(!1);return{visible:c,toggle:s=>{c.value=s}}});class k{constructor(e,s={}){a(this,"gl");a(this,"type");a(this,"buffer");a(this,"normalized",!1);Object.assign(this,s),this.gl=e,this.type=this.gl.getContext().FLOAT,this.buffer=this.gl.getContext().createBuffer(),this.update()}update(){if(this.values){const e=this.gl.getContext();e.bindBuffer(this.target,this.buffer),e.bufferData(this.target,this.values,e.STATIC_DRAW)}}attach(e,s){const n=this.gl.getContext(),i=n.getAttribLocation(s,e);return this.target===n.ARRAY_BUFFER&&(n.enableVertexAttribArray(i),n.vertexAttribPointer(i,this.size,this.type,this.normalized,0,0)),i}use(e){const s=this.gl.getContext();s.bindBuffer(this.target,this.buffer),this.target===s.ARRAY_BUFFER&&(s.enableVertexAttribArray(e),s.vertexAttribPointer(e,this.size,this.type,this.normalized,0,0))}}class ie{constructor(e,s,n,i={},l={}){a(this,"gl");a(this,"uniformInstances",[]);Object.assign(this,l),this.gl=e,this.uniforms=i;const o=this.gl.getContext(),u=`
...
`)}attachUniforms(e,s){e?s.type==="array"?s.value.forEach((n,i)=>{this.attachUniforms(`${e}[${i}]`,n)}):s.type==="struct"?Object.entries(s.value).forEach(([n,i])=>{this.attachUniforms(`${e}.${n}`,i)}):this.uniformInstances.push({uniform:s,location:this.gl.getContext().getUniformLocation(this.program,e)}):Object.entries(s).forEach(([n,i])=>{this.attachUniforms(n,i)})}}class ne{constructor(e,s,n,i={}){a(this,"gl");a(this,"wireframe",!1);a(this,"attributeInstances",[]);Object.assign(this,i),this.geometry=s,this.material=n,this.gl=e,Object.entries(this.geometry.attributes).forEach(([l,o])=>{this.attributeInstances.push({attribute:o,location:o.attach(l,this.material.program)})}),this.gl.meshes.push(this)}draw(){const e=this.gl.getContext();e.useProgram(this.material.program),this.material.uniformInstances.forEach(({uniform:n,location:i})=>{n.update(i)}),this.attributeInstances.forEach(({attribute:n,location:i})=>{n.use(i)});const s=this.wireframe?e.LINES:e.TRIANGLES;e.drawElements(s,this.geometry.attributes.index.values.length,e.UNSIGNED_SHORT,0)}remove(){this.gl.meshes=this.gl.meshes.filter(e=>e!=this)}}class oe{constructor(e,s,n,i,l,o,u={}){a(this,"gl");a(this,"attributes");Object.assign(this,u),this.gl=e;const m=this.gl.getContext();m.createBuffer(),this.attributes={position:new k(this.gl,{target:m.ARRAY_BUFFER,size:3}),uv:new k(this.gl,{target:m.ARRAY_BUFFER,size:2}),uvNorm:new k(this.gl,{target:m.ARRAY_BUFFER,size:2}),index:new k(this.gl,{target:m.ELEMENT_ARRAY_BUFFER,size:3,type:m.UNSIGNED_SHORT})},this.setTopology(i,l),this.setSize(s,n,o)}setTopology(e=1,s=1){this.xSegCount=e,this.ySegCount=s,this.vertexCount=(this.xSegCount+1)*(this.ySegCount+1),this.quadCount=this.xSegCount*this.ySegCount*2,this.attributes.uv.values=new Float32Array(2*this.vertexCount),this.attributes.uvNorm.values=new Float32Array(2*this.vertexCount),this.attributes.index.values=new Uint16Array(3*this.quadCount);for(let n=0;n<=this.ySegCount;n++)for(let i=0;i<=this.xSegCount;i++){const l=n*(this.xSegCount+1)+i;if(this.attributes.uv.values[2*l]=i/this.xSegCount,this.attributes.uv.values[2*l+1]=1-n/this.ySegCount,this.attributes.uvNorm.values[2*l]=i/this.xSegCount*2-1,this.attributes.uvNorm.values[2*l+1]=1-n/this.ySegCount*2,i<this.xSegCount&&n<this.ySegCount){const o=n*this.xSegCount+i;this.attributes.index.values[6*o]=l,this.attributes.index.values[6*o+1]=l+1+this.xSegCount,this.attributes.index.values[6*o+2]=l+1,this.attributes.index.values[6*o+3]=l+1,this.attributes.index.values[6*o+4]=l+1+this.xSegCount,this.attributes.index.values[6*o+5]=l+2+this.xSegCount}}this.attributes.uv.update(),this.attributes.uvNorm.update(),this.attributes.index.update()}setSize(e=1,s=1,n="xz"){this.width=e,this.height=s,this.orientation=n,this.attributes.position.values&&this.attributes.position.values.length===3*this.vertexCount||(this.attributes.position.values=new Float32Array(3*this.vertexCount));const i=e/-2,l=s/-2,o=e/this.xSegCount,u=s/this.ySegCount;for(let m=0;m<=this.ySegCount;m++){const w=l+m*u;for(let C=0;C<=this.xSegCount;C++){const T=i+C*o,L=m*(this.xSegCount+1)+C;this.attributes.position.values[3*L+"xyz".indexOf(n[0])]=T,this.attributes.position.values[3*L+"xyz".indexOf(n[1])]=-w}}this.attributes.position.update()}}class d{constructor(e,s,n,i={}){a(this,"gl");a(this,"type");a(this,"value");a(this,"typeFn");a(this,"_typeMap",{float:"1f",int:"1i",vec2:"2fv",vec3:"3fv",vec4:"4fv",mat4:"Matrix4fv"});Object.assign(this,i),this.gl=e,this.type=s,this.value=n,this.typeFn=this._typeMap[this.type]||this._typeMap.float,this.update()}update(e){if(this.value){var s=this.value,n=null;this.typeFn.indexOf("Matrix")===0&&(s=this.transpose,n=this.value),this.gl.getContext()[`uniform${this.typeFn}`](e,s,n)}}getDeclaration(e,s,n){if(this.excludeFrom!==s){if(this.type==="array")return`${this.value[0].getDeclaration(e,s,this.value.length)}
const int ${e}_length = ${this.value.length};`;if(this.type==="struct"){let i=e.replace("u_","");i=i.charAt(0).toUpperCase()+i.slice(1);const l=Object.entries(this.value).map(([o,u])=>u.getDeclaration(o,s).replace(/^uniform/,"")).join("");return`uniform struct ${i} {
    ${l}
...
`),new ie(this._minigl,this.vertexShader,this.shaderFiles.fragment,this.uniforms)}initMesh(){this.material=this.initMaterial(),this.geometry=new oe(this._minigl),this.mesh=new ne(this._minigl,this.geometry,this.material),this.mesh.wireframe=this.getOption("wireframe")}updateFrequency(e){this.freqX+=e,this.freqY+=e}toggleColor(e){this.activeColors[e]=this.activeColors[e]===0?1:0}init(){const e=this.getOption("loadedClass");e&&this.getCanvas().classList.add(e),this.initMesh(),this.resize(),requestAnimationFrame(this.animate.bind(this)),window.addEventListener("resize",this.resize)}normalizeColor(e){return[(e>>16&255)/255,(e>>8&255)/255,(255&e)/255]}};a($,"defaultOptions",{canvas:null,colors:["#f00","#0f0","#00f"],wireframe:!1,density:[.06,.16],angle:0,amplitude:320,static:!1,loadedClass:"is-loaded",zoom:1,speed:5,rotation:0});let I=$;const de=c=>(H("data-v-df747d73"),c=c(),Y(),c),he={class:"section__start section__wrapper"},me=de(()=>t("div",{class:"section__background"},[t("canvas",{id:"canvas",width:"32px",height:"32px"})],-1)),ue={class:"mt-52 mx-auto container relative"},ge={class:"title--ultra-large title--condensed title--slide-from-bottom element--visible",style:{"mix-blend-mode":"color-burn",opacity:"0.6"}},ve=["innerHTML"],pe={class:"title--ultra-large title--condensed title--slide-from-bottom element--visible",style:{position:"absolute",top:"0",left:"0",opacity:"0.4"}},_e=["innerHTML"],be={class:"section__container section__container--small-padding-top flex gap-12"},fe={class:"w-full lg:w-1/2"},ye=["innerHTML"],xe=R('<div class="hidden lg:block lg:w-1/2 relative" data-v-df747d73><div class="box__rounded box--animated" data-v-df747d73><h4 class="font-bold mb-4" data-v-df747d73>Fully responsive design</h4><img src="'+te+'" alt="Fully responsive web design" width="260px" title="Fully responsive, mobile web design" data-v-df747d73></div><div class="box__rounded box--bigger box--animated" data-v-df747d73><img src="'+se+'" alt="Web application developed in laravel framework" width="450px" title="Web application developed in laravel framework" data-v-df747d73></div></div>',1),we=x({__name:"Start",setup(c){const e=E(),s=S("onElementVisible"),n=()=>{z().visible=!0};return N(()=>{new I({canvas:"#canvas",colors:["#ff333d","#a960ee","#90e0ff","#ffcb57"]})}),(i,l)=>(p(),v("section",he,[me,t("div",ue,[t("h2",ge,[t("span",{innerHTML:i.$t("headingTitle")},null,8,ve)]),t("h2",pe,[t("span",{innerHTML:i.$t("headingTitle")},null,8,_e)])]),t("div",be,[t("div",fe,[t("p",{class:"leading-7 mt-12 title--slide-from-left",ref:r(s)},[t("span",{style:{"transition-delay":".6s"},innerHTML:i.$t("headingDescription")},null,8,ye)],512),t("div",{class:"title--slide-from-bottom flex gap-3",ref:r(s)},[t("button",{type:"button",class:"form__button form__button--arrow-right",onClick:b(n,["prevent"])},y(i.$t("collaborate")),1),t("button",{class:"form__button form__button--darker",onClick:l[0]||(l[0]=b(o=>r(e).toggle(!0),["prevent"]))},y(i.$t("checkoutSummary")),1)],512)]),xe])]))}}),Ce=j(we,[["__scopeId","data-v-df747d73"]]),Se={class:"section__wrapper"},Le={class:"section__container"},ke=["innerHTML"],$e={class:"technology__container mt-12"},ze={href:"https://github.com/lukasion/portfolio/tree/main",target:"_blank",class:"technology__item"},Me=t("p",{class:"technology__title"}," Checkout my work ",-1),Ee={href:"https://github.com/lukasion/portfolio/tree/main/laravel-api",target:"_blank",class:"technology__item",style:{"transition-delay":".6s"}},Te=t("p",{class:"technology__title"}," Checkout my work ",-1),Fe={class:"technology__item",style:{"transition-delay":".9s"}},Ae={class:"technology__item",style:{"transition-delay":"1.2s"}},De={class:"technology__item",style:{"transition-delay":"1.5s"}},Oe={href:"https://github.com/lukasion/portfolio/tree/main",target:"_blank",class:"technology__item",style:{"transition-delay":"1.8s"}},Be=t("p",{class:"technology__title"}," Checkout my work ",-1),Ie={href:"https://github.com/lukasion/portfolio/tree/main",target:"_blank",class:"technology__item",style:{"transition-delay":"2.1s"}},Ne=t("p",{class:"technology__title"}," Checkout my work ",-1),je={href:"https://github.com/lukasion/portfolio/tree/main/laravel-api",target:"_blank",class:"technology__item",style:{"transition-delay":"2.4s"}},Ve=t("p",{class:"technology__title"}," Checkout my work ",-1),Pe={href:"https://github.com/lukasion/portfolio/tree/main/assets/scss",target:"_blank",class:"technology__item",style:{"transition-delay":"2.7s"}},Re=t("p",{class:"technology__title"}," Checkout my work ",-1),He={href:"https://github.com/lukasion/portfolio/tree/main/assets/scss",target:"_blank",class:"technology__item",style:{"transition-delay":"3.0s"}},Ye=t("p",{class:"technology__title"}," Checkout my work ",-1),Ue={class:"technology__item",style:{"transition-delay":"3.3s"}},qe={class:"technology__item",style:{"transition-delay":"3.6s"}},Ge={class:"technology__item",style:{"transition-delay":"3.9s"}},We=x({__name:"Technologies",setup(c){const e=S("onElementVisible");return(s,n)=>{const i=M;return p(),v("section",Se,[t("div",Le,[t("h2",{class:"title--x-large title--condensed title--slide-from-bottom",ref:r(e)},[t("span",null,y(s.$t("technologies")),1)],512),t("p",{class:"leading-7 mt-5 title--slide-from-left",ref:r(e)},[t("span",{style:{"transition-delay":".6s"},innerHTML:s.$t("technologiesDescription")},null,8,ke)],512),t("div",$e,[t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("a",ze,[t("div",null,[h(i,{name:"logos:vue",size:"48px"}),g(" Vue.js ")]),Me])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("a",Ee,[t("div",null,[h(i,{name:"logos:laravel",size:"48px"}),g(" Laravel ")]),Te])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",Fe,[t("div",null,[h(i,{name:"devicon:livewire",size:"48px"}),g(" Livewire ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",Ae,[t("div",null,[h(i,{name:"logos:alpinejs-icon",size:"48px"}),g(" Alpine.js ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",De,[t("div",null,[h(i,{name:"logos:react",size:"48px"}),g(" React ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("a",Oe,[t("div",null,[h(i,{name:"logos:nuxt-icon",size:"48px"}),g(" Nuxt ")]),Be])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("a",Ie,[t("div",null,[h(i,{name:"logos:nodejs",size:"48px"}),g(" Node.js ")]),Ne])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("a",je,[t("div",null,[h(i,{name:"logos:php-alt",size:"48px"}),g(" PHP ")]),Ve])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("a",Pe,[t("div",null,[h(i,{name:"vscode-icons:file-type-scss2",size:"48px"}),g(" SCSS ")]),Re])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("a",He,[t("div",null,[h(i,{name:"logos:tailwindcss-icon",size:"48px"}),g(" Tailwind ")]),Ye])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",Ue,[t("div",null,[h(i,{name:"logos:docker-icon",size:"48px"}),g(" Docker ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",qe,[t("div",null,[h(i,{name:"logos:git",size:"48px"}),g(" Git ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",Ge,[t("div",null,[h(i,{name:"logos:github-copilot",size:"48px"}),g(" GitHub Copilot ")])])],512)])])])}}});class _{constructor(e,s={}){if(!(e instanceof Node))throw"Can't initialize VanillaTilt because "+e+" is not a Node.";this.width=null,this.height=null,this.clientWidth=null,this.clientHeight=null,this.left=null,this.top=null,this.gammazero=null,this.betazero=null,this.lastgammazero=null,this.lastbetazero=null,this.transitionTimeout=null,this.updateCall=null,this.event=null,this.updateBind=this.update.bind(this),this.resetBind=this.reset.bind(this),this.element=e,this.settings=this.extendSettings(s),this.reverse=this.settings.reverse?-1:1,this.resetToStart=_.isSettingTrue(this.settings["reset-to-start"]),this.glare=_.isSettingTrue(this.settings.glare),this.glarePrerender=_.isSettingTrue(this.settings["glare-prerender"]),this.fullPageListening=_.isSettingTrue(this.settings["full-page-listening"]),this.gyroscope=_.isSettingTrue(this.settings.gyroscope),this.gyroscopeSamples=this.settings.gyroscopeSamples,this.elementListener=this.getElementListener(),this.glare&&this.prepareGlare(),this.fullPageListening&&this.updateClientSize(),this.addEventListeners(),this.reset(),this.resetToStart===!1&&(this.settings.startX=0,this.settings.startY=0)}static isSettingTrue(e){return e===""||e===!0||e===1}getElementListener(){if(this.fullPageListening)return window.document;if(typeof this.settings["mouse-event-element"]=="string"){const e=document.querySelector(this.settings["mouse-event-element"]);if(e)return e}return this.settings["mouse-event-element"]instanceof Node?this.settings["mouse-event-element"]:this.element}addEventListeners(){this.onMouseEnterBind=this.onMouseEnter.bind(this),this.onMouseMoveBind=this.onMouseMove.bind(this),this.onMouseLeaveBind=this.onMouseLeave.bind(this),this.onWindowResizeBind=this.onWindowResize.bind(this),this.onDeviceOrientationBind=this.onDeviceOrientation.bind(this),this.elementListener.addEventListener("mouseenter",this.onMouseEnterBind),this.elementListener.addEventListener("mouseleave",this.onMouseLeaveBind),this.elementListener.addEventListener("mousemove",this.onMouseMoveBind),(this.glare||this.fullPageListening)&&window.addEventListener("resize",this.onWindowResizeBind),this.gyroscope&&window.addEventListener("deviceorientation",this.onDeviceOrientationBind)}removeEventListeners(){this.elementListener.removeEventListener("mouseenter",this.onMouseEnterBind),this.elementListener.removeEventListener("mouseleave",this.onMouseLeaveBind),this.elementListener.removeEventListener("mousemove",this.onMouseMoveBind),this.gyroscope&&window.removeEventListener("deviceorientation",this.onDeviceOrientationBind),(this.glare||this.fullPageListening)&&window.removeEventListener("resize",this.onWindowResizeBind)}destroy(){clearTimeout(this.transitionTimeout),this.updateCall!==null&&cancelAnimationFrame(this.updateCall),this.element.style.willChange="",this.element.style.transition="",this.element.style.transform="",this.resetGlare(),this.removeEventListeners(),this.element.vanillaTilt=null,delete this.element.vanillaTilt,this.element=null}onDeviceOrientation(e){if(e.gamma===null||e.beta===null)return;this.updateElementPosition(),this.gyroscopeSamples>0&&(this.lastgammazero=this.gammazero,this.lastbetazero=this.betazero,this.gammazero===null?(this.gammazero=e.gamma,this.betazero=e.beta):(this.gammazero=(e.gamma+this.lastgammazero)/2,this.betazero=(e.beta+this.lastbetazero)/2),this.gyroscopeSamples-=1);const s=this.settings.gyroscopeMaxAngleX-this.settings.gyroscopeMinAngleX,n=this.settings.gyroscopeMaxAngleY-this.settings.gyroscopeMinAngleY,i=s/this.width,l=n/this.height,o=e.gamma-(this.settings.gyroscopeMinAngleX+this.gammazero),u=e.beta-(this.settings.gyroscopeMinAngleY+this.betazero),m=o/i,w=u/l;this.updateCall!==null&&cancelAnimationFrame(this.updateCall),this.event={clientX:m+this.left,clientY:w+this.top},this.updateCall=requestAnimationFrame(this.updateBind)}onMouseEnter(){this.updateElementPosition(),this.element.style.willChange="transform",this.setTransition()}onMouseMove(e){this.updateCall!==null&&cancelAnimationFrame(this.updateCall),this.event=e,this.updateCall=requestAnimationFrame(this.updateBind)}onMouseLeave(){this.setTransition(),this.settings.reset&&requestAnimationFrame(this.resetBind)}reset(){this.onMouseEnter(),this.fullPageListening?this.event={clientX:(this.settings.startX+this.settings.max)/(2*this.settings.max)*this.clientWidth,clientY:(this.settings.startY+this.settings.max)/(2*this.settings.max)*this.clientHeight}:this.event={clientX:this.left+(this.settings.startX+this.settings.max)/(2*this.settings.max)*this.width,clientY:this.top+(this.settings.startY+this.settings.max)/(2*this.settings.max)*this.height};let e=this.settings.scale;this.settings.scale=1,this.update(),this.settings.scale=e,this.resetGlare()}resetGlare(){this.glare&&(this.glareElement.style.transform="rotate(180deg) translate(-50%, -50%)",this.glareElement.style.opacity="0")}getValues(){let e,s;this.fullPageListening?(e=this.event.clientX/this.clientWidth,s=this.event.clientY/this.clientHeight):(e=(this.event.clientX-this.left)/this.width,s=(this.event.clientY-this.top)/this.height),e=Math.min(Math.max(e,0),1),s=Math.min(Math.max(s,0),1);let n=(this.reverse*(this.settings.max-e*this.settings.max*2)).toFixed(2),i=(this.reverse*(s*this.settings.max*2-this.settings.max)).toFixed(2),l=Math.atan2(this.event.clientX-(this.left+this.width/2),-(this.event.clientY-(this.top+this.height/2)))*(180/Math.PI);return{tiltX:n,tiltY:i,percentageX:e*100,percentageY:s*100,angle:l}}updateElementPosition(){let e=this.element.getBoundingClientRect();this.width=this.element.offsetWidth,this.height=this.element.offsetHeight,this.left=e.left,this.top=e.top}update(){let e=this.getValues();this.element.style.transform="perspective("+this.settings.perspective+"px) rotateX("+(this.settings.axis==="x"?0:e.tiltY)+"deg) rotateY("+(this.settings.axis==="y"?0:e.tiltX)+"deg) scale3d("+this.settings.scale+", "+this.settings.scale+", "+this.settings.scale+")",this.glare&&(this.glareElement.style.transform=`rotate(${e.angle}deg) translate(-50%, -50%)`,this.glareElement.style.opacity=`${e.percentageY*this.settings["max-glare"]/100}`),this.element.dispatchEvent(new CustomEvent("tiltChange",{detail:e})),this.updateCall=null}prepareGlare(){if(!this.glarePrerender){const e=document.createElement("div");e.classList.add("js-tilt-glare");const s=document.createElement("div");s.classList.add("js-tilt-glare-inner"),e.appendChild(s),this.element.appendChild(e)}this.glareElementWrapper=this.element.querySelector(".js-tilt-glare"),this.glareElement=this.element.querySelector(".js-tilt-glare-inner"),!this.glarePrerender&&(Object.assign(this.glareElementWrapper.style,{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",overflow:"hidden","pointer-events":"none","border-radius":"inherit"}),Object.assign(this.glareElement.style,{position:"absolute",top:"50%",left:"50%","pointer-events":"none","background-image":"linear-gradient(0deg, rgba(255,255,255,0) 0%, rgba(255,255,255,1) 100%)",transform:"rotate(180deg) translate(-50%, -50%)","transform-origin":"0% 0%",opacity:"0"}),this.updateGlareSize())}updateGlareSize(){if(this.glare){const e=(this.element.offsetWidth>this.element.offsetHeight?this.element.offsetWidth:this.element.offsetHeight)*2;Object.assign(this.glareElement.style,{width:`${e}px`,height:`${e}px`})}}updateClientSize(){this.clientWidth=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth,this.clientHeight=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight}onWindowResize(){this.updateGlareSize(),this.updateClientSize()}setTransition(){clearTimeout(this.transitionTimeout),this.element.style.transition=this.settings.speed+"ms "+this.settings.easing,this.glare&&(this.glareElement.style.transition=`opacity ${this.settings.speed}ms ${this.settings.easing}`),this.transitionTimeout=setTimeout(()=>{this.element.style.transition="",this.glare&&(this.glareElement.style.transition="")},this.settings.speed)}extendSettings(e){let s={reverse:!1,max:15,startX:0,startY:0,perspective:1e3,easing:"cubic-bezier(.03,.98,.52,.99)",scale:1,speed:300,transition:!0,axis:null,glare:!1,"max-glare":1,"glare-prerender":!1,"full-page-listening":!1,"mouse-event-element":null,reset:!0,"reset-to-start":!0,gyroscope:!0,gyroscopeMinAngleX:-45,gyroscopeMaxAngleX:45,gyroscopeMinAngleY:-45,gyroscopeMaxAngleY:45,gyroscopeSamples:10},n={};for(var i in s)if(i in e)n[i]=e[i];else if(this.element.hasAttribute("data-tilt-"+i)){let l=this.element.getAttribute("data-tilt-"+i);try{n[i]=JSON.parse(l)}catch{n[i]=l}}else n[i]=s[i];return n}static init(e,s){e instanceof Node&&(e=[e]),e instanceof NodeList&&(e=[].slice.call(e)),e instanceof Array&&e.forEach(n=>{"vanillaTilt"in n||(n.vanillaTilt=new _(n,s))})}}typeof document<"u"&&(window.VanillaTilt=_,_.init(document.querySelectorAll("[data-tilt]")));const Xe=_,Qe={class:"section__dark section__wrapper"},Je={class:"section__container"},Ke=t("h2",{class:"title--x-large title--condensed"},"What can I offer?",-1),Ze={class:"collab__background"},et={class:"collab__content"},tt=t("h2",{class:"title--large title--condensed"},"Websites",-1),st=t("p",null," The websites I build are fast, secure and easy to manage. I use the latest technologies to ensure your website is future-proof and scalable. ",-1),it=t("div",{class:"collab__box collab__box--empty"},null,-1),nt={class:"collab__background collab__background--on-demand"},ot={class:"collab__content"},at=t("h2",{class:"title--large title--condensed"},"On-demand programming",-1),lt=t("p",null," Do you need a custom solution for your business? I can build a web application tailored to your needs. I can also help you with your existing project. ",-1),rt=t("div",{class:"collab__box collab__box--empty"},null,-1),ct={class:"collab__background collab__background--seo"},dt={class:"collab__content"},ht=t("h2",{class:"title--large title--condensed"},"SEO",-1),mt=t("p",null," Search Engine Optimisation is a crucial part of any website. I can help you improve your website's ranking in search engines. ",-1),ut=t("div",{class:"collab__box collab__box--empty"},null,-1),gt=x({__name:"Collab",setup(c){const e=S("onElementVisible"),s=()=>{z().visible=!0},n=f([]),i=l=>{n.value.push(l)};return N(()=>{Xe.init(n.value,{speed:200,glare:!0,"max-glare":.2,gyroscope:!1,perspective:700,scale:1.05})}),(l,o)=>(p(),v("div",Qe,[t("div",Je,[Ke,t("div",{class:"collab__container",ref:r(e)},[t("div",{class:"collab__box",ref:i},[t("div",Ze,[t("div",et,[tt,st,t("a",{class:"mt-5 block hover:underline hover:cursor-pointer",onClick:b(s,["prevent"])}," Create a website ")])])]),it,t("div",{class:"collab__box",ref:i},[t("div",nt,[t("div",ot,[at,lt,t("a",{class:"mt-5 block hover:underline hover:cursor-pointer",onClick:b(s,["prevent"])}," Maintain an existing project ")])])])],512),t("div",{class:"collab__container md:!mt-16",ref:r(e)},[rt,t("div",{class:"collab__box",ref:i},[t("div",ct,[t("div",dt,[ht,mt,t("a",{class:"mt-5 block hover:underline hover:cursor-pointer",onClick:b(s,["prevent"])}," Rank up my webpage ")])])]),ut],512)])]))}}),vt={class:"section__wrapper"},pt={class:"section__container"},_t=t("span",null,"You can find me also here",-1),bt=[_t],ft=t("span",{style:{"transition-delay":".6s"}}," I am active on many social media platforms. You can find me primarily on GitHub, and LinkedIn. I am also available via email. If you want to get in touch with me, feel free to contact me on any of the platforms listed below. ",-1),yt=[ft],xt={class:"technology__container mt-12"},wt={class:"technology__item"},Ct={class:"technology__item",style:{"transition-delay":"0.6s"}},St={class:"technology__item",style:{"transition-delay":"0.9s"}},Lt={class:"technology__item",style:{"transition-delay":"1.2s"}},kt=x({__name:"Socials",setup(c){const e=S("onElementVisible");return(s,n)=>{const i=M;return p(),v("section",vt,[t("div",pt,[t("h2",{class:"title--x-large title--condensed title--slide-from-bottom",ref:r(e)},bt,512),t("p",{class:"leading-7 mt-5 title--slide-from-left",ref:r(e)},yt,512),t("div",xt,[t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",wt,[t("div",null,[h(i,{name:"logos:github-icon",size:"48px"}),g(" GitHub ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",Ct,[t("div",null,[h(i,{name:"logos:linkedin-icon",size:"48px"}),g(" LinkedIn ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",St,[t("div",null,[h(i,{name:"logos:facebook",size:"48px"}),g(" Facebook ")])])],512),t("div",{class:"technology__item-wrapper title--slide-from-bottom",ref:r(e)},[t("span",Lt,[t("div",null,[h(i,{name:"logos:google-gmail",size:"48px"}),g(" Google Mail ")])])],512)])])])}}}),$t=window.setInterval,zt={class:"section__container"},Mt=t("span",null,"About me",-1),Et=[Mt],Tt={key:0,class:"code__preloader"},Ft={key:1,class:"code__container"},At=R('<div data-line-nr="01" class="code__line"><div class="methods">class</div><span class="propname">Łukasz Fujarski</span><div class="methods">extends</div><div class="propname">Developer</div> { </div><div data-line-nr="02" class="code__line"><div class="dot">··</div><div class="comment"> // &quot;Don&#39;t comment bad code – rewrite it.&quot; - Brian Kernighan. </div></div><div data-line-nr="03" class="code__line"><div class="dot">··</div><div class="comment"> // &quot;Give someone a program; you frustrate them for a day; teach them how to program, and you frustrate them for a lifetime&quot; – David Leinweber. </div></div><div data-line-nr="04" class="code__line"></div><div data-line-nr="05" class="code__line"><div class="dot">··</div><div class="propname"><div class="methods">public string </div><span class="variable">$name</span><span class="methods">;</span></div></div><div data-line-nr="06" class="code__line"><div class="dot">··</div><div class="propname"><div class="methods">public string </div><span class="variable">$email</span><span class="methods">;</span></div></div><div data-line-nr="07" class="code__line"><div class="dot">··</div><div class="propname"><div class="methods">private string </div><span class="variable">$dayOfBirthTimestamp</span><span class="methods">;</span></div></div><div data-line-nr="08" class="code__line"></div><div data-line-nr="09" class="code__line"><div class="dot">··</div><div class="propname"><div class="methods">public function </div><span class="methodname">__construct</span>() </div></div><div data-line-nr="10" class="code__line"><div class="dot">··</div><div class="propname"> { </div></div><div data-line-nr="11" class="code__line"><div class="dot">·....·</div><span class="variable">$this<span class="arrow">-&gt;</span>name</span>                = <span class="string">&#39;Łukasz Fujarski&#39;;</span></div><div data-line-nr="12" class="code__line"><div class="dot">·....·</div><span class="variable">$this<span class="arrow">-&gt;</span>email</span>               = <span class="string">&#39;lukasz.fujarski@gmail.com&#39;;</span></div><div data-line-nr="13" class="code__line"><div class="dot">·....·</div><span class="variable">$this<span class="arrow">-&gt;</span>dayOfBirthTimestamp</span> = <span class="string">856059633;</span></div><div data-line-nr="14" class="code__line"><div class="dot">··</div><div class="propname"> } </div></div><div data-line-nr="15" class="code__line"></div><div data-line-nr="16" class="code__line"><div class="dot">··</div><div class="propname"><div class="methods">public function </div><span class="methodname">workExperience</span>(): <span class="methods">array</span></div></div><div data-line-nr="17" class="code__line"><div class="dot">··</div><div class="propname"> { </div></div><div data-line-nr="18" class="code__line"><div class="dot">······</div><div class="methods">return</div> [ </div><div data-line-nr="19" class="code__line"><div class="dot">······</div><div>     &#39;2022 - now&#39; =&gt; &#39;Full Stack Developer at <a href="https://tech-studio.pl/" target="_blank">Tech-Studio S.C.</a>&#39;, </div></div><div data-line-nr="20" class="code__line"><div class="dot">······</div><div>     &#39;2018 - 2022&#39; =&gt; &#39;PHP Developer at <a href="https://tech-studio.pl/" target="_blank">Tech-Studio S.C.</a>&#39; </div></div><div data-line-nr="21" class="code__line"><div class="dot">······</div><div> ]; </div></div><div data-line-nr="22" class="code__line"><div class="dot">··</div><div class="propname"> } </div></div><div data-line-nr="23" class="code__line"></div><div data-line-nr="24" class="code__line"><div class="dot">··</div><div class="propname"><div class="methods">public function </div><span class="methodname lg:tooltip" data-tip="Method defines only few of the technologies I&#39;ve worked with. Through the time working as web developer I&#39;ve gained experience in many more programming languages, frameworks and tools.">skills</span>(): <span class="methods">array</span></div></div><div data-line-nr="25" class="code__line"><div class="dot">··</div><div class="propname"> { </div></div><div data-line-nr="26" class="code__line"><div class="dot">······</div><div class="methods">return</div> [&#39;JavaScript&#39;, &#39;PHP&#39;, &#39;CSS&#39;, &#39;Laravel Framework&#39;, &#39;SCSS&#39;, &#39;Vue.js 2 &amp; 3&#39;, &#39;Nuxt.js&#39;, &#39;Tailwind CSS&#39;, &#39;Git&#39;, &#39;MySQL&#39;, &#39;Docker&#39;, &#39;Linux&#39;, &#39;Apache&#39;, &#39;Webpack&#39;, &#39;Composer&#39;, &#39;NPM&#39;, &#39;Node.js&#39;, &#39;Adobe Photoshop&#39;, &#39;Microsoft Office&#39;, &#39;Microsoft Excel&#39;, &#39;Microsoft SQL Server&#39;, &#39;Microsoft Power BI&#39;, &#39;Pinia&#39;, &#39;Vuex&#39;, &#39;Vuetify&#39;, &#39;Bootstrap&#39;, &#39;jQuery&#39;, &#39;HTML&#39;, &#39;REST API&#39;, &#39;Python&#39;, &#39;C#&#39;]; </div><div data-line-nr="27" class="code__line"><div class="dot">··</div><div class="propname"> } </div></div><div data-line-nr="28" class="code__line"><div class="propname"> } </div></div>',28),Dt=[At],Ot={__name:"Code",setup(c){const e=f(!0),s=f("..."),n=f(null),i=S("onElementVisible"),l=E();return Q(n,([{isIntersecting:u}],m)=>{u&&(n.value&&m.unobserve(n.value),setTimeout(()=>{e.value=!1},4e3),$t(()=>{s.value==="..."?s.value="":s.value+="."},300))}),(u,m)=>(p(),v("div",null,[t("div",zt,[t("h2",{class:"title--x-large title--condensed",ref:r(i)},Et,512),t("button",{class:"form__button form__button--dark",onClick:m[0]||(m[0]=b(w=>r(l).toggle(!0),["prevent"]))}," Checkout my skills chart ")]),t("div",{class:"code",ref_key:"editor",ref:n},[r(e)?(p(),v("div",Tt,[g(" LOADING ENVIRONMENT "),t("span",null,y(r(s)),1)])):(p(),v("div",Ft,Dt))],512)]))}},Bt=Ot,It={class:"modal"},Nt={class:"modal__container"},jt={class:"modal__content"},Vt=t("div",{class:"modal__header"},[t("h2",{class:"title--x-large title--condensed"},[t("span",null,"Get in touch with me")]),t("p",{class:"leading-7 mt-5"},[t("span",{style:{"transition-delay":".6s"}}," You can contact me via email, or by filling out the form below. I will try to respond as soon as possible. ")])],-1),Pt={class:"modal__form"},Rt={action:""},Ht={class:"form__input-container"},Yt={class:"form__input-container"},Ut={class:"form__input-container"},qt={class:"modal__form-input"},Gt=x({__name:"Contact",setup(c){const e=z(),s=f({name:"",email:"",message:""});return(n,i)=>{const l=M;return p(),v("div",It,[t("div",Nt,[t("button",{class:"modal__close",onClick:i[0]||(i[0]=b(o=>r(e).visible=!1,["prevent"]))},[h(l,{name:"material-symbols:close-small",class:"w-15 h-15 text-5xl"})]),t("div",jt,[Vt,t("div",Pt,[t("form",Rt,[t("div",Ht,[F(t("input",{class:"form__input",t:"",type:"text",id:"name",placeholder:"Your name","onUpdate:modelValue":i[1]||(i[1]=o=>r(s).name=o)},null,512),[[A,r(s).name]])]),t("div",Yt,[F(t("input",{class:"form__input",type:"email",id:"email",placeholder:"Your e-mail address","onUpdate:modelValue":i[2]||(i[2]=o=>r(s).email=o)},null,512),[[A,r(s).email]])]),t("div",Ut,[F(t("textarea",{class:"form__input",id:"message",placeholder:"Your message","onUpdate:modelValue":i[3]||(i[3]=o=>r(s).message=o)},null,512),[[A,r(s).message]])]),t("div",qt,[t("button",{onClick:i[4]||(i[4]=b(o=>r(e).submit(r(s)),["prevent"])),class:"form__button form__button--dark"}," Contact request ")])])])])])])}}}),P=c=>(H("data-v-96178cac"),c=c(),Y(),c),Wt={class:"skills-chart__container"},Xt={class:"skills-chart__content"},Qt=P(()=>t("h2",{class:"title--x-large title--condensed"},[t("span",null,"My skills summary")],-1)),Jt=P(()=>t("p",{class:"leading-7 mt-5"},[t("span",{style:{"transition-delay":".6s"}}," Here you can see my skills chart. I have divided my skills into three categories: frontend, backend, and other. You can see the percentage of my skills in each category. ")],-1)),Kt={class:"title--large mt-10 mb-4"},Zt={class:"w-full shadow-md text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 rounded-lg overflow-hidden"},es=P(()=>t("thead",{class:"text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400"},[t("tr",null,[t("th",{class:"px-6 py-3"},"Technologies"),t("th",{class:"px-6 py-3"},"Features")])],-1)),ts={class:"bg-white border-b dark:bg-gray-800 dark:border-gray-700"},ss={class:"px-6 py-4"},is={class:"px-6 py-4"},ns={class:"flex flex-wrap gap-1 gap-y-3"},os={class:"badge"},as={__name:"SkillsChart",setup(c){const e=E(),s=f([{name:"Frontend",technologies:[{name:"Vue.js",features:["Vue 2","Vue 3","Composition API","Options API","Vuex Store","Vue Router","Pinia","Vite","Webpack","Quasar","Vuetfy","VCalendar","VueUse"]},{name:"Nuxt.js",features:["Nuxt 3","Nuxt Mapbox","Nuxt Mail","Nuxt Icon","Sidebase/Nuxt Auth"]},{name:"Others",features:["Tailwind CSS","Alpine.js","Bootstrap","jQuery"]}]},{name:"Backend",technologies:[{name:"Laravel",features:["Laravel 7-10","Livewire","Sanctum","Sail","Spatie","Passport","Tinker","Mix","Homestead","Sail","Queues","Jobs","MVC","Migrations & Seeders","Requests","Cache","Mails","Broadcasts","Notifications","Task Scheduling","Hashing"]},{name:"Livewire",features:["Livewire 3"]},{name:"Symfony",features:["Twig","Doctrine","Console","Forms","Routing","Validator","Yaml"]},{name:"Node.js",features:["Express.js","Sequelize","REST API","NPM","PM2","Nodemon","Puppeteer","OpenAI","GCloud"]}]},{name:"Other",technologies:[{name:"Git",features:["GitHub","Git CLI","Github Copilot"]},{name:"Docker",features:["Docker Compose","Docker Hub","Docker Desktop","Docker CLI","Dockerfile"]},{name:"Linux",features:["Ubuntu","Debian","Fedora"]},{name:"Apache",features:["Virtual Hosts","Modules","Configuration"]}]}]);return(n,i)=>{const l=M;return p(),v("div",{class:B(["skills-chart",{active:r(e).visible}])},[t("div",Wt,[t("button",{class:"skills-chart__close",onClick:i[0]||(i[0]=b(o=>r(e).toggle(!1),["prevent"]))},[h(l,{name:"material-symbols:close-small",class:"w-15 h-15 text-5xl"})]),t("div",Xt,[Qt,Jt,(p(!0),v(D,null,O(r(s),o=>(p(),v("div",null,[t("h3",Kt,y(o.name),1),t("table",Zt,[es,(p(!0),v(D,null,O(o.technologies,u=>(p(),v("tbody",null,[t("tr",ts,[t("td",ss,y(u.name),1),t("td",is,[t("div",ns,[(p(!0),v(D,null,O(u.features,m=>(p(),v("div",os,y(m),1))),256))])])])]))),256))])]))),256))])])],2)}}},ls=j(as,[["__scopeId","data-v-96178cac"]]),rs={class:"app__container"},cs=x({__name:"index",setup(c){const e=z(),s=E();return(n,i)=>{const l=G,o=Ce,u=We,m=gt,w=ee,C=kt,T=Bt,L=Gt;return p(),v("div",rs,[t("div",{class:B(["app__main",{"app__main--offseted":r(s).visible}])},[h(l),h(o),h(u),h(w,null,{default:J(()=>[h(m)]),_:1}),h(C),h(T),h(K)],2),h(L,{class:B({active:r(e).visible})},null,8,["class"]),h(ls)])}}}),bs=j(cs,[["__scopeId","data-v-a64f2a4e"]]);export{bs as default};
