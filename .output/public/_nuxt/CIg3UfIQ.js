var j=Object.defineProperty;var V=(h,e,s)=>e in h?j(h,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):h[e]=s;var a=(h,e,s)=>(V(h,typeof e!="symbol"?e+"":e,s),s);import{_ as I}from"./Na0b9Eoi.js";import{f as C,r as f,z as A,A as R,c as v,B as q,C as L,o as p,a as t,h as r,s as U,q as S,D as y,p as Y,e as W,t as b,b as d,d as g,E as X,j as G,F as E,x as F,w as J}from"./8gTyVxTI.js";import{u as H,_ as Q}from"./DBVq18YK.js";import{_ as B}from"./DlAUqK2U.js";import O from"./ZxaTiom-.js";import{_ as K}from"./Bhf3dPYw.js";import"./CSQbAwuk.js";import"./Bcw-ZHf8.js";const Z=Symbol.for("nuxt:client-only"),ee=C({name:"ClientOnly",inheritAttrs:!1,props:["fallback","placeholder","placeholderTag","fallbackTag"],setup(h,{slots:e,attrs:s}){const n=f(!1);return A(()=>{n.value=!0}),R(Z,!0),i=>{var m;if(n.value)return(m=e.default)==null?void 0:m.call(e);const o=e.fallback||e.placeholder;if(o)return o();const l=i.fallback||i.placeholder||"",u=i.fallbackTag||i.placeholderTag||"span";return v(u,s,l)}}}),te=""+new URL("mobile.9S7sboHz.jpg",import.meta.url).href,se=""+new URL("doger-desktop.n8T5WlF3.jpg",import.meta.url).href,T=q("skillsChart",()=>{const h=f(!1);return{visible:h,toggle:s=>{h.value=s}}});class M{constructor(e,s={}){a(this,"gl");a(this,"type");a(this,"buffer");a(this,"normalized",!1);Object.assign(this,s),this.gl=e,this.type=this.gl.getContext().FLOAT,this.buffer=this.gl.getContext().createBuffer(),this.update()}update(){if(this.values){const e=this.gl.getContext();e.bindBuffer(this.target,this.buffer),e.bufferData(this.target,this.values,e.STATIC_DRAW)}}attach(e,s){const n=this.gl.getContext(),i=n.getAttribLocation(s,e);return this.target===n.ARRAY_BUFFER&&(n.enableVertexAttribArray(i),n.vertexAttribPointer(i,this.size,this.type,this.normalized,0,0)),i}use(e){const s=this.gl.getContext();s.bindBuffer(this.target,this.buffer),this.target===s.ARRAY_BUFFER&&(s.enableVertexAttribArray(e),s.vertexAttribPointer(e,this.size,this.type,this.normalized,0,0))}}class ie{constructor(e,s,n,i={},o={}){a(this,"gl");a(this,"uniformInstances",[]);Object.assign(this,o),this.gl=e,this.uniforms=i;const l=this.gl.getContext(),u=`
