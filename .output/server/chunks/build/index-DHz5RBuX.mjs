...
import { u as useModalStore, a as _sfc_main$6, _ as _sfc_main$1$1 } from './Footer-9Auhc8Y7.mjs';
...
import { d as defineStore, _ as __nuxt_component_3, e as useIntersectionObserver } from './server.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import __nuxt_component_1$1 from './Icon-kqhLPqFV.mjs';
import { _ as _sfc_main$7 } from './Contact-B5OIhScP.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_1$1;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section__wrapper" }, _attrs))}><div class="section__container"><h2 class="title--x-large title--condensed title--slide-from-bottom"><span>${_ctx.$t("socialsTitle")}</span></h2><p class="leading-7 mt-5 title--slide-from-left"><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}">${_ctx.$t("socialsDescription")}</span></p><div class="technology__container mt-12"><div class="technology__item-wrapper title--slide-from-bottom"><a href="https://github.com/lukasion" target="_blank" class="technology__item"><div>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "logos:github-icon",
        size: "48px"
      }, null, _parent));
      _push(` GitHub </div></a></div><div class="technology__item-wrapper title--slide-from-bottom"><a href="https://linkedin.com/in/lukasz-fujarski" target="_blank" class="technology__item" style="${ssrRenderStyle({ "transition-delay": "0.6s" })}"><div>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "logos:linkedin-icon",
        size: "48px"
      }, null, _parent));
      _push(` LinkedIn </div></a></div><div class="technology__item-wrapper title--slide-from-bottom"><a href="mailto:lukasz.fujarski@gmail.com" target="_blank" class="technology__item" style="${ssrRenderStyle({ "transition-delay": "1.2s" })}"><div>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "logos:google-gmail",
        size: "48px"
      }, null, _parent));
      _push(` Google Mail </div></a></div></div></div></section>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-a276fd01><div class="skills-chart__container" data-v-a276fd01><button class="skills-chart__close" data-v-a276fd01>`);
      _push(ssrRenderComponent(_component_icon, {
        name: "material-symbols:close-small",
        class: "w-15 h-15 text-5xl"
      }, null, _parent));
      _push(`</button><div class="skills-chart__content" data-v-a276fd01><h2 class="title--x-large title--condensed" data-v-a276fd01><span data-v-a276fd01>${_ctx.$t("mySkillsTitle")}</span></h2><p class="leading-7 mt-5" data-v-a276fd01><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}" data-v-a276fd01>${_ctx.$t("mySkillsDescription")}</span></p><!--[-->`);
      ssrRenderList(unref(items), (item) => {
        _push(`<div data-v-a276fd01><h3 class="title--large mt-10 mb-4" data-v-a276fd01>${ssrInterpolate(item.name)}</h3><table class="w-full shadow-md text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 rounded-lg overflow-hidden" data-v-a276fd01><thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400" data-v-a276fd01><tr data-v-a276fd01><th class="px-2 py-3 text-center" data-v-a276fd01>${ssrInterpolate(_ctx.$t("technologiesShort"))}</th><th class="px-4 py-3" data-v-a276fd01>${ssrInterpolate(_ctx.$t("features"))}</th></tr></thead><!--[-->`);
        ssrRenderList(item.technologies, (technology) => {
          _push(`<tbody data-v-a276fd01><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" data-v-a276fd01><td class="py-4 text-center" data-v-a276fd01>${ssrInterpolate(technology.name)}</td><td class="px-4 py-4" data-v-a276fd01><div class="flex flex-wrap gap-1 gap-y-3" data-v-a276fd01><!--[-->`);
          ssrRenderList(technology.features, (feature) => {
            _push(`<div class="badge" data-v-a276fd01>${ssrInterpolate(feature)}</div>`);
          });
...
const SkillsChart = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a276fd01"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ModalContact = _sfc_main$7;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "app__container" }, _attrs))} data-v-9cbc407c><div class="${ssrRenderClass([{ "app__main--offseted": unref(skillsChartStore).visible }, "app__main"])}" data-v-9cbc407c>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9cbc407c"]]);

export { index as default };
//# sourceMappingURL=index-DHz5RBuX.mjs.map
