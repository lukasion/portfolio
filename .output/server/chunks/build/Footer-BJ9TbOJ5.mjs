...
import { d as defineStore, f as useNuxtApp } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="text-md">+48 786 826 806</p></a></div><div class="title--slide-from-bottom"><button type="button" class="form__button">${ssrInterpolate(_ctx.$t("touch"))}</button></div></div></footer>`);
    };
  }
});
...
//# sourceMappingURL=Footer-BJ9TbOJ5.mjs.map
