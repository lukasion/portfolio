...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section__start section__wrapper" }, _attrs))}><div class="section__background"><canvas id="canvas" width="32px" height="32px"></canvas></div><div class="mt-48 mx-auto container relative"><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "mix-blend-mode": "overlay" })}"><span>Websites done <br>the right way!</span></h2><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "position": "absolute", "top": "0", "left": "0", "opacity": "0.4" })}"><span>Websites done <br>the right way!</span></h2></div><div class="section__container section__container--small-padding-top"><p class="leading-7 title--slide-from-left"><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}"> I am a web developer based in Katowice, Poland. I specialise in building websites and web applications using modern technologies. <br>If you are a business seeking a web presence or an employer looking to hire, you can get in touch with me here. </span></p><div class="title--slide-from-bottom flex gap-3"><button type="button" class="form__button"> Let&#39;s colaborate on a project </button><button class="form__button form__button--darker"> Checkout my skills chart </button></div></div></section>`);
    };
  }
});
...
//# sourceMappingURL=index-UMCf_YdM.mjs.map
