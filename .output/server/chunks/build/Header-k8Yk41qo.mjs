import { _ as __nuxt_component_0 } from './nuxt-link-C-TSYBmv.mjs';
import __nuxt_component_0$1 from './Icon-Dd8f0AnZ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<ul class="${ssrRenderClass({ "active": mobileVisible.value })}"><!--[-->`);
      ...
      _push(`<!--]--></ul><div class="header__hamburger md:hidden">`);
...
//# sourceMappingURL=Header-k8Yk41qo.mjs.map
