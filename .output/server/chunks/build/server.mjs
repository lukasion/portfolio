import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineComponent, provide, createElementBlock, defineAsyncComponent, readonly, shallowReactive, h, Suspense, nextTick, Transition, computed, useSSRContext, unref, getCurrentScope, onScopeDispose, createApp, effectScope, reactive, isReactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, toRefs, markRaw, isShallow, mergeProps } from 'vue';
import { f as useRuntimeConfig$1, $ as $fetch$1, z as withQuery, A as hasProtocol, B as parseURL, C as isScriptProtocol, w as joinURL, k as createError$1, D as klona, a as defu, F as sanitizeStatusCode, G as defuFn, H as createHooks, b as appendHeader, I as getRequestHeaders, c as sendRedirect, J as getHeader, K as toRouteMatcher, L as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./generate-BRfbwq9C.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_slug_-DQlMwXvH.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BreXVTHu.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DvzdccAP.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "user",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/user",
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect,
    component: () => import('./user-76XgPnzG.mjs').then((m) => m.default || m),
    children: [
      {
        name: "user-auth",
        path: "auth",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./auth-Oy_KVQLs.mjs').then((m) => m.default || m)
      },
      {
        name: "user-posts",
        path: "posts",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./posts-BZrKfGtO.mjs').then((m) => m.default || m),
        children: [
          {
            ...
            alias: [],
            redirect: void 0 ,
            component: () => import('./_slug_-Bu50q4-Q.mjs').then((m) => m.default || m)
          },
          {
            ...
            alias: [],
            redirect: void 0 ,
            component: () => import('./_slug_-CASn3yEt.mjs').then((m) => m.default || m)
          }
        ]
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./topics-Dai5_94n.mjs').then((m) => m.default || m),
        children: [
          {
            ...
            alias: [],
            redirect: void 0 ,
            component: () => import('./_slug_-cUNlrazb.mjs').then((m) => m.default || m)
          },
          {
            ...
            alias: [],
            redirect: void 0 ,
            component: () => import('./_slug_-DOwke03M.mjs').then((m) => m.default || m)
          }
        ]
      }
    ]
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-Dd8f0AnZ.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CemyMVs0.mjs').then((r) => r.default));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DcZyyY-S.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BQ71nPQm.mjs').then((r) => r.default || r));
...
export { __nuxt_component_3 as _, useRoute as a, useRouter as b, useIntersectionObserver as c, defineStore as d, entry$1 as default, useNuxtApp as e, __nuxt_component_1 as f, useAuth as g, useRuntimeConfig as h, navigateTo as i, asyncDataDefaults as j, createError as k, fetchDefaults as l, useRequestFetch as m, nuxtLinkDefaults as n, useAppConfig as o, useState as p, useHead as u };
