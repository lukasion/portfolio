...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_slug_-psJRwe8E.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BgHSUeHp.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-C7wk_LWl.mjs').then((m) => m.default || m)
  },
  {
    name: "lang-slug",
    path: "/lang/:slug()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./offer-DHA2m8cB.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_slug_-DbuB6rGu.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DS-EX7ny.mjs').then((m) => m.default || m)
  },
  {
