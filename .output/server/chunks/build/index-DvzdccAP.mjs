...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderAttr, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList } from 'vue/server-renderer';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section__start section__wrapper" }, _attrs))} data-v-3cb77463><div class="section__background" data-v-3cb77463><canvas id="canvas" width="32px" height="32px" data-v-3cb77463></canvas></div><div class="mt-52 mx-auto container relative" data-v-3cb77463><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "mix-blend-mode": "color-burn", "opacity": "0.6" })}" data-v-3cb77463><span data-v-3cb77463>Websites done <br data-v-3cb77463>the right way!</span></h2><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "position": "absolute", "top": "0", "left": "0", "opacity": "0.4" })}" data-v-3cb77463><span data-v-3cb77463>Websites done <br data-v-3cb77463>the right way!</span></h2></div><div class="section__container section__container--small-padding-top flex gap-12" data-v-3cb77463><div class="w-full lg:w-1/2" data-v-3cb77463><p class="leading-7 mt-4 title--slide-from-left" data-v-3cb77463><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}" data-v-3cb77463> I am a web developer based in Katowice, Poland. I specialise in building websites and web applications using modern technologies. <br data-v-3cb77463> <br data-v-3cb77463>If you are a business seeking a web presence or an employer looking to hire, you\xA0can get in touch with me here. </span></p><div class="title--slide-from-bottom flex gap-3" data-v-3cb77463><button type="button" class="form__button form__button--arrow-right" data-v-3cb77463> Let&#39;s colaborate on a project </button><button class="form__button form__button--darker" data-v-3cb77463> Checkout my skills summary </button></div></div><div class="hidden lg:block lg:w-1/2 relative" data-v-3cb77463><div class="box__rounded box--animated" data-v-3cb77463><h4 class="font-bold mb-4" data-v-3cb77463>Fully responsive design</h4><img${ssrRenderAttr("src", _imports_0)} alt="Fully responsive web design" width="260px" title="Fully responsive, mobile web design" data-v-3cb77463></div><div class="box__rounded box--bigger box--animated" data-v-3cb77463><img${ssrRenderAttr("src", _imports_1)} alt="Web application developed in laravel framework" width="450px" title="Web application developed in laravel framework" data-v-3cb77463></div></div></div></section>`);
    };
  }
});
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-3cb77463"]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-96178cac><div class="skills-chart__container" data-v-96178cac><button class="skills-chart__close" data-v-96178cac>`);
      _push(ssrRenderComponent(_component_icon, {
        name: "material-symbols:close-small",
        class: "w-15 h-15 text-5xl"
      }, null, _parent));
      _push(`</button><div class="skills-chart__content" data-v-96178cac><h2 class="title--x-large title--condensed" data-v-96178cac><span data-v-96178cac>My skills summary</span></h2><p class="leading-7 mt-5" data-v-96178cac><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}" data-v-96178cac> Here you can see my skills chart. I have divided my skills into three categories: frontend, backend, and other. You can see the percentage of my skills in each category. </span></p><!--[-->`);
      ssrRenderList(unref(items), (item) => {
        _push(`<div data-v-96178cac><h3 class="title--large mt-10 mb-4" data-v-96178cac>${ssrInterpolate(item.name)}</h3><table class="w-full shadow-md text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 rounded-lg overflow-hidden" data-v-96178cac><thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400" data-v-96178cac><tr data-v-96178cac><th class="px-6 py-3" data-v-96178cac>Technologies</th><th class="px-6 py-3" data-v-96178cac>Features</th></tr></thead><!--[-->`);
        ssrRenderList(item.technologies, (technology) => {
          _push(`<tbody data-v-96178cac><tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" data-v-96178cac><td class="px-6 py-4" data-v-96178cac>${ssrInterpolate(technology.name)}</td><td class="px-6 py-4" data-v-96178cac><div class="flex flex-wrap gap-1 gap-y-3" data-v-96178cac><!--[-->`);
          ssrRenderList(technology.features, (feature) => {
            _push(`<div class="badge" data-v-96178cac>${ssrInterpolate(feature)}</div>`);
          });
...
const SkillsChart = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-96178cac"]]);
...
//# sourceMappingURL=index-DvzdccAP.mjs.map
