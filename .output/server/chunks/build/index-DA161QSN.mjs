...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section__start section__wrapper" }, _attrs))} data-v-3834d5f9><div class="section__background" data-v-3834d5f9><canvas id="canvas" width="32px" height="32px" data-v-3834d5f9></canvas></div><div class="mt-52 mx-auto container relative" data-v-3834d5f9><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "mix-blend-mode": "color-burn", "opacity": "0.6" })}" data-v-3834d5f9><span data-v-3834d5f9>Websites done <br data-v-3834d5f9>the right way!</span></h2><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "position": "absolute", "top": "0", "left": "0", "opacity": "0.4" })}" data-v-3834d5f9><span data-v-3834d5f9>Websites done <br data-v-3834d5f9>the right way!</span></h2></div><div class="section__container section__container--small-padding-top flex gap-12" data-v-3834d5f9><div class="w-full lg:w-1/2" data-v-3834d5f9><p class="leading-7 title--slide-from-left" data-v-3834d5f9><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}" data-v-3834d5f9> I am a web developer based in Katowice, Poland. I specialise in building websites and web applications using modern technologies. <br data-v-3834d5f9>If you are a business seeking a web presence or an employer looking to hire, you can get in touch with me here. </span></p><div class="title--slide-from-bottom flex gap-3" data-v-3834d5f9><button type="button" class="form__button" data-v-3834d5f9> Let&#39;s colaborate on a project </button><button class="form__button form__button--darker" data-v-3834d5f9> Checkout my skills chart </button></div></div><div class="hidden lg:block lg:w-1/2 relative" data-v-3834d5f9><div class="box__rounded" data-v-3834d5f9><h4 class="font-bold mb-4" data-v-3834d5f9>Fully responsive design</h4><img${ssrRenderAttr("src", _imports_0)} alt="Fully responsive web design" width="260px" title="Fully responsive, mobile web design" data-v-3834d5f9></div></div></div></section>`);
    };
  }
});
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-3834d5f9"]]);
...
//# sourceMappingURL=index-DA161QSN.mjs.map
