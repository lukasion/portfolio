...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "bg-[#222222] text-white" }, _attrs))}><div class="py-12 mx-auto container"><h4 class="text-xl font-bold">Find me on:</h4><div class="flex flex-col items-start gap-3 mt-6"><a href="https://linkedin.com/in/lukasz-fujarski" target="_blank" class="flex items-center gap-3">`);
...
//# sourceMappingURL=Footer-CVXPLQlZ.mjs.map
