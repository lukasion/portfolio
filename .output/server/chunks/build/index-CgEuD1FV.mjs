...
import { _ as _sfc_main$8 } from './Header-3XZ74bbr.mjs';
...
import { u as useModalStore, _ as _sfc_main$7 } from './Footer-DgXfIh4k.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section__start section__wrapper" }, _attrs))} data-v-b2c86045><div class="${ssrRenderClass([{ "section__background--gradient": !unref(desktop) }, "section__background"])}" data-v-b2c86045>`);
      if (unref(desktop)) {
        _push(`<canvas id="canvas" width="32px" height="32px" data-v-b2c86045></canvas>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mt-32 md:mt-72 mx-auto container relative" data-v-b2c86045><h2 class="px-4 md:px-0 title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "mix-blend-mode": "color-burn", "opacity": "0.6" })}" data-v-b2c86045><span data-v-b2c86045>${_ctx.$t("headingTitle")}</span></h2><h2 class="px-4 md:px-0 title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "position": "absolute", "top": "0", "left": "0", "opacity": "0.4" })}" data-v-b2c86045><span data-v-b2c86045>${_ctx.$t("headingTitle")}</span></h2></div><div class="${ssrRenderClass([{ "element--visible": unref(mounted) }, "section__container mt-8 section__container--small-padding-top flex gap-12 z-100"])}" data-v-b2c86045><div class="w-full lg:w-1/2" data-v-b2c86045><p class="leading-7 md:mt-12 title--slide-from-left" data-v-b2c86045><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}" data-v-b2c86045>${_ctx.$t("headingDescription")}</span></p><div class="${ssrRenderClass([{ "element--visible": unref(mounted) }, "title--slide-from-bottom flex md:gap-3 flex-col md:flex-row"])}" data-v-b2c86045><button type="button" class="form__button form__button--arrow-right !mt-4 md:mt-10" data-v-b2c86045><span data-v-b2c86045>${_ctx.$t("collaborate")}</span></button><button class="form__button form__button--darker !mt-4 md:mt-10" data-v-b2c86045><span data-v-b2c86045>${_ctx.$t("checkoutSummary")}</span></button></div></div><div class="hidden lg:block lg:w-1/2 relative" data-v-b2c86045><div class="box__rounded box--animated" data-v-b2c86045><h4 class="font-bold mb-4" data-v-b2c86045><span data-v-b2c86045>${_ctx.$t("responsiveDesign")}</span></h4><img${ssrRenderAttr("src", _imports_0)} alt="Fully responsive web design" width="260px" title="Fully responsive, mobile web design" data-v-b2c86045></div><div class="box__rounded box--bigger box--animated" data-v-b2c86045><img${ssrRenderAttr("src", _imports_1)} alt="Web application developed in laravel framework" width="450px" title="Web application developed in laravel framework" data-v-b2c86045></div></div></div></section>`);
    };
  }
});
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-b2c86045"]]);
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</button><div class="modal__content"><div class="modal__header"><h2 class="title--x-large title--condensed"><span>${ssrInterpolate(_ctx.$t("touchFull"))}</span></h2><p class="leading-7 mt-5"><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}">${ssrInterpolate(_ctx.$t("touchDescription"))}</span></p><a href="tel:+48786826806" target="_blank" class="flex items-center gap-3">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "material-symbols:phone",
        size: "32px",
        color: "white"
      }, null, _parent));
      _push(`<p class="text-md">+48 786 826 806</p></a></div><div class="modal__form"><form action=""><div class="form__input-container"><input class="form__input" t type="text" id="name"${ssrRenderAttr("placeholder", _ctx.$t("yourName"))}${ssrRenderAttr("value", unref(form).name)}></div><div class="form__input-container"><input class="form__input" type="email" id="email"${ssrRenderAttr("placeholder", _ctx.$t("yourEmail"))}${ssrRenderAttr("value", unref(form).email)}></div><div class="form__input-container"><textarea class="form__input" id="message"${ssrRenderAttr("placeholder", _ctx.$t("yourMessage"))}>${ssrInterpolate(unref(form).message)}</textarea></div><div class="modal__form-input"><button class="form__button form__button--dark">${ssrInterpolate(_ctx.$t("contactRequest"))}</button></div></form></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=index-CgEuD1FV.mjs.map
