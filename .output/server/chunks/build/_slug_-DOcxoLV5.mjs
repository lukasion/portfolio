import { _ as _sfc_main$3 } from './input-DhMd53SA.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "form-control" }, _attrs))}><label class="label"><span class="label-text">${ssrInterpolate(unref(labelComputed))}:</span></label><label class="input-group"><textarea rows="10"${ssrRenderAttr("placeholder", __props.placeholder)} class="${ssrRenderClass(["textarea textarea-bordered", props.class])}"${ssrIncludeBooleanAttr(__props.required) ? " required" : ""}>${ssrInterpolate(__props.value)}</textarea></label></div>`);
    };
  }
});
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_form_input, {
        ...
        placeholder: "Name",
        required: "",
        value: (_b = unref(articlesStore).article) == null ? void 0 : _b.title
      }, null, _parent));
...
//# sourceMappingURL=_slug_-DOcxoLV5.mjs.map
