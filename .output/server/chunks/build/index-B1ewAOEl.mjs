...
import { u as useModalStore, _ as _sfc_main$7 } from './Footer-ClPkAjNs.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section__start section__wrapper" }, _attrs))} data-v-3bf1288b><div class="${ssrRenderClass([{ "section__background--gradient": !unref(desktop) }, "section__background"])}" data-v-3bf1288b>`);
      if (unref(desktop)) {
        _push(`<canvas id="canvas" width="32px" height="32px" data-v-3bf1288b></canvas>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mt-32 md:mt-72 mx-auto container relative" data-v-3bf1288b><h2 class="px-4 md:px-0 title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "mix-blend-mode": "color-burn", "opacity": "0.6" })}" data-v-3bf1288b><span data-v-3bf1288b>${_ctx.$t("headingTitle")}</span></h2><h2 class="px-4 md:px-0 title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "position": "absolute", "top": "0", "left": "0", "opacity": "0.4" })}" data-v-3bf1288b><span data-v-3bf1288b>${_ctx.$t("headingTitle")}</span></h2></div><div class="${ssrRenderClass([{ "element--visible": unref(mounted) }, "section__container mt-8 section__container--small-padding-top flex gap-12 z-100"])}" data-v-3bf1288b><div class="w-full lg:w-1/2" data-v-3bf1288b><p class="leading-7 md:mt-12 title--slide-from-left" data-v-3bf1288b><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}" data-v-3bf1288b>${_ctx.$t("headingDescription")}</span></p><div class="${ssrRenderClass([{ "element--visible": unref(mounted) }, "title--slide-from-bottom flex md:gap-3 flex-col md:flex-row"])}" data-v-3bf1288b><button type="button" class="form__button form__button--arrow-right" data-v-3bf1288b><span data-v-3bf1288b>${_ctx.$t("collaborate")}</span></button><button class="form__button form__button--darker !mt-4 md:mt-10" data-v-3bf1288b><span data-v-3bf1288b>${_ctx.$t("checkoutSummary")}</span></button></div></div><div class="hidden lg:block lg:w-1/2 relative" data-v-3bf1288b><div class="box__rounded box--animated" data-v-3bf1288b><h4 class="font-bold mb-4" data-v-3bf1288b><span data-v-3bf1288b>${_ctx.$t("responsiveDesign")}</span></h4><img${ssrRenderAttr("src", _imports_0)} alt="Fully responsive web design" width="260px" title="Fully responsive, mobile web design" data-v-3bf1288b></div><div class="box__rounded box--bigger box--animated" data-v-3bf1288b><img${ssrRenderAttr("src", _imports_1)} alt="Web application developed in laravel framework" width="450px" title="Web application developed in laravel framework" data-v-3bf1288b></div></div></div></section>`);
    };
  }
});
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-3bf1288b"]]);
...
//# sourceMappingURL=index-B1ewAOEl.mjs.map
