...
import { u as useModalStore, _ as _sfc_main$7 } from './Footer-R6kp47SV.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</button><div class="modal__content"><div class="modal__header"><h2 class="title--x-large title--condensed"><span>${ssrInterpolate(_ctx.$t("touchFull"))}</span></h2><p class="leading-7 mt-5"><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}">${ssrInterpolate(_ctx.$t("touchDescription"))}</span></p></div><div class="modal__form"><form action=""><div class="form__input-container"><input class="form__input" t type="text" id="name"${ssrRenderAttr("placeholder", _ctx.$t("yourName"))}${ssrRenderAttr("value", unref(form).name)}></div><div class="form__input-container"><input class="form__input" type="email" id="email"${ssrRenderAttr("placeholder", _ctx.$t("yourEmail"))}${ssrRenderAttr("value", unref(form).email)}></div><div class="form__input-container"><textarea class="form__input" id="message"${ssrRenderAttr("placeholder", _ctx.$t("yourMessage"))}>${ssrInterpolate(unref(form).message)}</textarea></div><div class="modal__form-input"><button class="form__button form__button--dark">${ssrInterpolate(_ctx.$t("contactRequest"))}</button></div></form></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=index-Bk_FhYvi.mjs.map
