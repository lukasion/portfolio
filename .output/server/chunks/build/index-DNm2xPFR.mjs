...
import { _ as _sfc_main$8 } from './Header-Dxs_331I.mjs';
import { useSSRContext, defineComponent, inject, mergeProps, ref, unref } from 'vue';
import { ssrRenderAttrs, ssrRenderStyle, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderClass, ssrRenderList } from 'vue/server-renderer';
import { u as useModalStore, _ as _sfc_main$7 } from './Footer-BzluV6FY.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section__start section__wrapper" }, _attrs))} data-v-df747d73><div class="section__background" data-v-df747d73><canvas id="canvas" width="32px" height="32px" data-v-df747d73></canvas></div><div class="mt-52 mx-auto container relative" data-v-df747d73><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "mix-blend-mode": "color-burn", "opacity": "0.6" })}" data-v-df747d73><span data-v-df747d73>${_ctx.$t("headingTitle")}</span></h2><h2 class="title--ultra-large title--condensed title--slide-from-bottom element--visible" style="${ssrRenderStyle({ "position": "absolute", "top": "0", "left": "0", "opacity": "0.4" })}" data-v-df747d73><span data-v-df747d73>${_ctx.$t("headingTitle")}</span></h2></div><div class="section__container section__container--small-padding-top flex gap-12" data-v-df747d73><div class="w-full lg:w-1/2" data-v-df747d73><p class="leading-7 mt-12 title--slide-from-left" data-v-df747d73><span style="${ssrRenderStyle({ "transition-delay": ".6s" })}" data-v-df747d73>${_ctx.$t("headingDescription")}</span></p><div class="title--slide-from-bottom flex gap-3" data-v-df747d73><button type="button" class="form__button form__button--arrow-right" data-v-df747d73>${ssrInterpolate(_ctx.$t("collaborate"))}</button><button class="form__button form__button--darker" data-v-df747d73>${ssrInterpolate(_ctx.$t("checkoutSummary"))}</button></div></div><div class="hidden lg:block lg:w-1/2 relative" data-v-df747d73><div class="box__rounded box--animated" data-v-df747d73><h4 class="font-bold mb-4" data-v-df747d73>Fully responsive design</h4><img${ssrRenderAttr("src", _imports_0)} alt="Fully responsive web design" width="260px" title="Fully responsive, mobile web design" data-v-df747d73></div><div class="box__rounded box--bigger box--animated" data-v-df747d73><img${ssrRenderAttr("src", _imports_1)} alt="Web application developed in laravel framework" width="450px" title="Web application developed in laravel framework" data-v-df747d73></div></div></div></section>`);
    };
  }
});
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-df747d73"]]);
...
//# sourceMappingURL=index-DNm2xPFR.mjs.map
