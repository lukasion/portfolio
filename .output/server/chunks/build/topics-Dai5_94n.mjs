import { _ as __nuxt_component_0, a as __nuxt_component_2 } from './Footer-CgPWq1uW.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="container mx-auto mt-10"><div class="card shadow-md"><div class="card-body gap-0"><h1 class="text-2xl font-bold">Topics</h1>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/user/topics.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const topics = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { topics as default };
//# sourceMappingURL=topics-Dai5_94n.mjs.map
