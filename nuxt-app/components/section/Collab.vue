	...
	<div class="section__dark section__wrapper">
		<div class="section__container">
			...
			<div class="collab__container">
				<div class="collab__box" data-tilt data-tilt-gyroscope="false" data-tilt-scale="1.05"
				     data-tilt-speed="200" data-tilt-glare="true" data-tilt-max-glare="0.2" data-tilt-perspective="700">
					<div class="collab__background">
						<div class="collab__content">
							...
							<a class="mt-5 block hover:underline hover:cursor-pointer" @click.prevent="displayModal">Create
								a website</a>
						</div>
					</div>
				</div>
				...
				<div class="collab__box" data-tilt data-tilt-gyroscope="false" data-tilt-scale="1.05"
					...
					<div class="collab__background collab__background--on-demand">
						<div class="collab__content">
							...
							<a class="mt-5 block hover:underline hover:cursor-pointer" @click.prevent="displayModal">Maintain
			...
			<div class="collab__container !mt-16">
				<div class="collab__box collab__box--empty"></div>
				<div class="collab__box" data-tilt data-tilt-gyroscope="false" data-tilt-scale="1.05"
				     data-tilt-speed="200" data-tilt-glare="true" data-tilt-max-glare="0.2" data-tilt-perspective="700">
					<div class="collab__background collab__background--seo">
						<div class="collab__content">
							...
							<p>
								Search Engine Optimisation is a&nbsp;crucial part of any website. I&nbsp;can help you
								improve your website's ranking in search engines.
							</p>
							<a class="mt-5 block hover:underline hover:cursor-pointer" @click.prevent="displayModal">Rank
								up my webpage</a>
						</div>
					</div>
				</div>
