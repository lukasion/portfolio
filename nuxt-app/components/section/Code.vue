	...
	<div class="code" ref="editor">
		...
		<div class="code__container" v-else>
			...
			<div data-line-nr="05" class="code__line">
				...
				<div class="propname">
					<div class="methods">public function&nbsp;</div>
					<span class="methodname">workExperience</span>()
				</div>
			</div>
			<div data-line-nr="08" class="code__line">
				<div class="dot">··</div>
			...
			<div data-line-nr="01" class="code__line">
				<div class="dot">······</div>
				<div>
					&nbsp;&nbsp;&nbsp;&nbsp;'2022 - now' => 'Full Stack Developer at <a href="https://tech-studio.pl/"
			...
			<div data-line-nr="05" class="code__line">
				...
				<div class="propname">
					<div class="methods">public function&nbsp;</div>
					<span class="methodname">skills</span>()
				</div>
			</div>
			<div data-line-nr="08" class="code__line">
				<div class="dot">··</div>
			...
			<div data-line-nr="01" class="code__line">
				...
				'Git', 'MySQL', 'Docker', 'Linux', 'Apache', 'Webpack', 'Composer', 'NPM', 'Node.js', 'Adobe Photoshop',
				'Microsoft Office', 'Microsoft Excel', 'Microsoft SQL Server', 'Microsoft Power BI', 'Pinia', 'Vuex',
